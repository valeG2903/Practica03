...
<h1>Registra Revista</h1>
	...
	<form action="registraModalidad" id="id_form" method="post"> 
			...
			<div class="form-group">
				...
				<input class="form-control" id="id_serie" name="serie" placeholder="Ingrese la serie" type="text" maxlength="2"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_categoria">Categoria</label>
				<input class="form-control" id="id_categoria" name="categoria" placeholder="Ingrese la categoria" type="text" maxlength="2"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_fechaLanzamiento">Fecha Lanzamiento</label>
				<input class="form-control" id="id_fechaLanzamiento" name="fechaLanzamiento" placeholder="Ingrese la fecha de lanzamiento" type="text" maxlength="2"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_fechaEdicion">Fecha Edicion</label>
				<input class="form-control" id="id_fechaEdicion" name="fechaEdicion" placeholder="Ingrese la fecha de edicion" type="text" maxlength="2"/>
			</div>
			<div class="form-group">
				<label class="control-label" for="id_categoria">Categoria</label>
        ...
        fechaLanzamiento: {
            ...
            validators: {
                ...
                lessThan: {
	                value: 35,
	                inclusive: true,
	                message: 'La fecha lanzamiento es'
	            },
	            greaterThan: {
	                value: 18,
	                inclusive: true,
